...
export default function ROICalculator() {
  ...
  // ICE scooter ~30km/L, EV costs ~R0.15/km (solar charged)
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-text-secondary mb-8">
        Adjust the sliders to compare monthly ICE fleet fuel costs against EV charging costs.
      </p>

      <div className="grid md:grid-cols-3 gap-8 mb-10">
        <SliderInput label="Fleet Size" value={fleetSize} min={5} max={50} step={5} unit=" scooters" onChange={setFleetSize} />
        <SliderInput label="Daily Distance / Scooter" value={dailyKm} min={30} max={150} step={10} unit=" km" onChange={setDailyKm} />
